                    ...
                    {currentActiveTask ? (
                        ...
                        (() => {
                            switch (view) {
                                ...
                                case 'PRODUCTS': return <ProductsScreen products={products} setProducts={setProducts} ingredients={effectiveIngredients} nutrients={nutrients} bases={bases} setBases={setBases} onOpenInNewWindow={(data, name) => handleOpenTask('OPTIMIZATION', name, data)} onNavigate={setView} setIsDirty={setIsDirty} onSelectDiets={(ids) => handleToggleDietSelection(ids, true)} />;
