      ...
      <div className="grid grid-cols-4 gap-3">
          ...
          >
              ...
              <div className="flex items-center gap-3 relative z-10 w-full">
                  <img src="/icons/ai_assistant2.gif" className="w-10 h-10 object-cover rotate-12 filter grayscale group-hover:grayscale-0 group-hover:scale-110 group-hover:rotate-0 transition-all duration-300 rounded-full border border-purple-500/30 shadow-[0_0_15px_rgba(168,85,247,0.4)]" alt="VETIA" />
