              ...
              {[
                ...
                return (
                  <div key={item.id}>
                    ...
                    {/* Sub-menu for Optimization REPLACED BY INTERNAL SIDEBAR IN GroupOptimizationScreen */}
                    {isOptim && isActive && (
                        <div className="mt-2 ml-4 p-3 bg-cyan-900/10 border border-cyan-500/20 rounded-xl animate-fade-in">
                           <p className="text-[9px] font-black text-cyan-400 uppercase tracking-widest text-center italic">Escritorio de Formulación Activo</p>
                        </div>
                    )}
                  </div>
                );
