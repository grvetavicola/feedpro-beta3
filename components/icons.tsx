...
export const FlaskIcon = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547a2 2 0 00-.547 1.806l.443 2.216a2 2 0 001.287 1.678l1.086.543a6 6 0 004.86 0l1.086-.543a2 2 0 001.287-1.678l.443-2.216a2 2 0 00-.547-1.806z" />
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 01-6 0V6a3 3 0 016 0v6z" />
  </svg>
);
...
export const SparklesIcon = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414L10 17l-4 4 4-4 5.293-5.293a1 1 0 011.414 0L21 17" />
  </svg>
);
...
export const PrintIcon = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H7a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm2-9V4a2 2 0 00-2-2H9a2 2 0 00-2 2v4" />
    </svg>
);
...
export const ChevronDoubleRightIcon = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const MonitorIcon = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18m-16 4h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
    </svg>
);
...
export const SpriteIcon = ({ name, className = 'w-6 h-6' }: { name: 'nutrients' | 'products' | 'formulate' | 'ingredients' | 'ai' | 'ratios', className?: string }) => {
  ...
  let pos = '';
  switch(name) {
    case 'nutrients': bg = '/set1feedpro.png'; pos = 'left center'; break;
    case 'products': bg = '/set1feedpro.png'; pos = 'center center'; break;
    case 'formulate': bg = '/set1feedpro.png'; pos = 'right center'; break;
    case 'ingredients': bg = '/set3feedpro.png'; pos = 'left center'; break;
    case 'ai': bg = '/set3feedpro.png'; pos = 'center center'; break;
    case 'ratios': bg = '/set3feedpro.png'; pos = 'right center'; break;
    default: return null;
  }
  return (
    <div 
...
export const NutrientsIcon = (props: any) => <SpriteIcon name="nutrients" {...props} />;
...
export const AIIcon = (props: any) => <img src="/icons/ai_assistant.png" className={`object-contain filter brightness-0 invert transition-all duration-300 ${props.className || 'w-10 h-10'}`} alt="VETIA AI" {...props} />;
