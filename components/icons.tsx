...
export const AIIcon = (props: any) => <img src="/icons/ai_assistant2.gif" className={`rounded-full border border-cyan-500/30 object-cover ${props.className || 'w-6 h-6'}`} alt="VETIA AI" {...props} />;
